  ...
  const menu = {
    ...
    scents : {
      ...
      options:{
        name: "Basic Scents",
        list:[
          { id:"apple", name:"Apple Orchard Bloom", cost:0 , icon:"https://raw.githubusercontent.com/Cables97/product-configurator/863812e44040bc2fb02e8bdbcfc55d9e423c759e/src/components/icons/pumpkin.svg"},
        ],
      },
